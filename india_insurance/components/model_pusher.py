...
from india_insurance.entity.config_entity import ModelPusherConfig
...
class ModelPusher:
    def __init__(self,model_pusher_config:ModelPusherConfig,
        ...
        try:
            ...
            self.model_resolver = ModelResolver(model_registry=self.model_pusher_config.saved_model_directory)
    ...
    def initiate_model_pusher(self,)->ModelPusherArtifact:
        try:
            ...
            model_pusher_artifact = ModelPusherArtifact(pusher_model_dir=self.model_pusher_config.pusher_model_directory,
                                                        saved_model_dir=self.model_pusher_config.saved_model_directory)
            ...
            return IndiaInsuranceException(e,sys)
